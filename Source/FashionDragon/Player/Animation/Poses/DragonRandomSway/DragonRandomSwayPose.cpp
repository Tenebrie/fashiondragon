...
{
	BodyDrivers = { new FDragonRandomSwayDriverBody(Anim, Anim->ControlledBody.GetBone(EBodyDriverLayer::Sway)) };
	HipsDrivers = { new FDragonRandomSwayDriverHips(Anim, Anim->ControlledHips.GetBone(EBodyDriverLayer::Sway)) };
}
